...
### Syndikat DAO - Unite Rebel Create!
...
<div className={styles.videoSection}>
  ...
  <div className={styles.textWrapper}>
    {typeof window !== 'undefined' ? (
      <p>
Decentralised power, pure innovation! A network of free spirits, creative pioneers, and web3 warriors, united by a shared vision of liberation.      </p>
    ) : (
