...
<div className={styles.videoSection}>
  <div className={styles.videoWrapper}>
    <img src="/brennt1.png" autoPlay muted loop width="100%" height="auto" />
  </div>
...
<Steps>
### Prepare for DAS Brennt
- Secure your festival pass
- Propose event ideas
- Volunteer for festival roles

### Participate in DAS Brennt
- Attend innovative workshops
- Engage in thought-provoking discussions
- Experience immersive art installations

### Contribute to DAS Brennt
- Showcase your projects
- Collaborate with fellow visionaries
- Shape the festival's future

### Carry the Spirit Forward
- Implement learnings in DAS ecosystem
- Foster year-round community engagement
- Prepare for the next DAS Brennt
</Steps>
