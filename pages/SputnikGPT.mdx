...
<div className={styles.videoSection}>
  <div className={styles.videoWrapper}>
    <video src="/sputnik.mp4" autoPlay muted loop width="100%" height="auto" />
...
<Steps>
[Include steps similar to previous pages, outlining how SputnikGPT is developed, implemented, and used within the DAS ecosystem]
</Steps>
